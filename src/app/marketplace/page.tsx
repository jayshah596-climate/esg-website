...
import { ArrowRight, Shield, Download, Headphones } from 'lucide-react'
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 hero-animated-bg grid-pattern">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-8">
            Instantly downloadable, practitioner-built ESG and climate tools. Save weeks of work and thousands in consulting fees.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <SectionHeader
            ...
            subtitle="Everything from GHG calculators to full reporting toolkits — developed and tested in real ESG engagements."
          />
